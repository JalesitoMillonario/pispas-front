...
export default function EnProcesoPage() {
  ...
  const loadIncidents = useCallback(async (isAutoRefresh = false) => {
    ...
    const data = await apiClient.entities.Incident.filter({ status: 'in_progress' }, "-updated_date");
    setIncidents(data);
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 p-6">
      <div className="max-w-7xl mx-auto">
        <PageHeader 
          ...
          description="Incidencias que están siendo gestionadas por el equipo técnico."
        ...
        {!isLoading && filteredIncidents.length === 0 && (
          <div className="text-center py-20 text-blue-700">
            <p>No hay incidencias en proceso en este momento.</p>
          </div>
        )}
