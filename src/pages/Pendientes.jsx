...
export default function PendientesPage() {
  ...
  const [lastUpdate, setLastUpdate] = useState(new Date()); // This state is still here but not rendered
  const [isRefreshing, setIsRefreshing] = useState(false); // This state is still here but not rendered
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <Tabs defaultValue="mecanica" className="w-full mt-6">
